...
LOAD_FIL_DATA:
  ...
  CALL SQLEXEC 0,"EXECSQL DECLARE C FIL CURSOR FOR S_FIL"
  CALL SQLEXEC 0,"EXECSQL PREPARE S_FIL INTO :OUTSQLDA FROM :SQLSTMT"
  CALL SQLEXEC 0,"EXECSQL OPEN C_FIL"
  do forever
    CALL SQLEXEC 0,"EXECSQL FETCH C_FIL USING DESCRIPTOR :OUTSQLDA"
    if SQLCODE = 100 then leave
    ITEMID  = OUTSQLDA.1.SQLDATA
    FTYPE   = OUTSQLDA.2.SQLDATA
    FCOLOR  = OUTSQLDA.3.SQLDATA
  ...
  CALL SQLEXEC 0,"EXECSQL CLOSE C_FIL"
RETURN
...
LOAD_PROJ_DATA:
  ...
  CALL SQLEXEC 0,"EXECSQL DECLARE C_PROJ CURSOR FOR S_PROJ"
  CALL SQLEXEC 0,"EXECSQL PREPARE S_PROJ INTO :OUTSQLDA FROM :SQLSTMT"
  CALL SQLEXEC 0,"EXECSQL OPEN C_PROJ"
  do forever
    CALL SQLEXEC 0,"EXECSQL FETCH C_PROJ USING DESCRIPTOR :OUTSQLDA"
    if SQLCODE = 100 then leave
    PNAME  = OUTSQLDA.1.SQLDATA
    PFILE  = OUTSQLDA.2.SQLDATA
  ...
  CALL SQLEXEC 0,"EXECSQL CLOSE C_PROJ"
RETURN
